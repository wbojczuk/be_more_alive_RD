...
import styles from './fatherhoodcoahing.module.css';

export default function FatherhoodCoachingContent(){
return (
 <div className={styles.donateContent}>
    <div className="center">
    <div className={styles.p}><h2 >
        Coaching with <span className="underline">Purpose</span>
<br /><br />
Faith<span className="highlight">.</span> Fatherhood<span className="highlight">.</span> Freedom<span className="highlight">.</span>
<br /><br />
Helping men rise above pain, reconnect with purpose, and walk in their identity through faith-based coaching.
    </h2>
    <br /><br />

<div><h3>Identity & Purpose Coaching</h3></div>
<br />
<strong>Who Am I in Christ?</strong><br />
...
<br />
<strong>Restore. Lead. Love.</strong><br />
...
<br />
<strong>Healed Men Heal Families.</strong><br />
...
<br />
<strong>Lead as a Man of God.</strong><br />
...
<div><h3>Relationship & Abstinence Coaching</h3></div>
<br />
<strong>Wait Well. Heal First.</strong><br />
...
<br />
<strong>Stay Grounded. Stay Growing.</strong><br />
...
<br />
<strong>Create Your Own Path.</strong><br />
